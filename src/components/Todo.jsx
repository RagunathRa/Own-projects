...
const FormComponent = () => {
  ...
  const show = () => {
    toast.current.show({ severity: 'info', summary: 'ADDED', detail: 'Form added successfully' });
  };
    ...
    <div>
      ...
      <DataTable value={formData}>
        ...
        <Column
          ...
          header="Expiry Date"
          body={(rowData) =>
            rowData.expiryDate instanceof Date ? rowData.expiryDate.toLocaleDateString() : rowData.expiryDate
          }
        />
      </DataTable>
    </div>
